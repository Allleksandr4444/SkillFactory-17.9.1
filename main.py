'''Так как в задании не указано какой тип чисел должен быть выведен через пробел, для удобства я привожу все числа в тип float'''
...
def bubble_sort(array):  # функция ортировки списка по возрастанию элементов в нем (пузырьком)
